...
## Title
RefProGen: A Retrieval-Guided Molecular Generation Model with Protein-Ligand Joint Representation for Property-Aware Drug Design
...
To address these issues, we propose a novel generative model based on protein-molecule representation for targeted molecular design named RefProGen. 
![image](model.png)

## Setup
Please install RefProGen in a virtual environment to ensure it has conflicting dependencies.
```
Python == 3.8
PyTorch == 1.13.1
scikit-learn == 1.5.0
